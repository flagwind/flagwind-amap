        ...
        <div class="api">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;radius: [number, number]&nbsp;&nbsp;&nbsp;&nbsp;// 椭圆的半径，单位：米，用2个元素的数组表示横向和纵向<br />
                            }
                        </td>
                        <td>{center, radius}</td>
                        <td>动态属性</td>
                    ...
                    <tr>
                        <td>zIndex</td>
                        <td>椭圆覆盖物的叠加顺序。地图上存在多个椭圆覆盖物叠加时，通过该属性使级别较高的椭圆覆盖物在上层显示。</td>
                        <td>number</td>
                        <td>动态属性</td>
                        <td>10</td>
                    </tr>
                    ...
                    <tr>
                        <td>fillOpacity</td>
                        <td>椭圆填充透明度，取值范围0-1，0表示完全透明，1表示不透明。默认为0.9。</td>
                        <td>number</td>
                        <td>动态属性</td>
                        <td>0.9</td>
                    </tr>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>move</td>
                        <td>编辑状态下，拖拽圆心调整椭圆位置时触发此事件。</td>
                        <td>{source, lnglat}</td>
                    </tr>
                    <tr>
                        <td>adjust</td>
                        <td>编辑状态下，鼠标调整椭圆半径时，触发此事件。</td>
                        <td>{source, radius}</td>
                    </tr>
                    <tr>
                        <td>end</td>
...
import * as code from "examples/codes/ellipse";

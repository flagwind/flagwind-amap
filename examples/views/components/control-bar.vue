<template>
    <l-article>
        <h1>ControlBar 控制条</h1>
        <h2>概述</h2>
        <p>组合了旋转、倾斜、复位、缩放在内的地图控件，在3D地图模式下会显示。</p>
        <h2>代码示例</h2>
        ...
        <div class="api">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>position</td>
                        <td>显示位置，如：{top: "10px", right: "10px"}。</td>
                        <td>object</td>
                        <td>静态属性</td>
                        <td>-</td>
                    </tr>
                    <tr>
                        <td>showZoomBar</td>
                        <td>是否显示缩放按钮。移动端默认为false，PC端为默认为true。</td>
                        <td>boolean</td>
                        <td>静态属性</td>
                        <td>-</td>
                    </tr>
                    <tr>
                        <td>showControlButton</td>
                        <td>是否显示倾斜、旋转按钮。移动端默认为false，PC端为默认为true。</td>
                        <td>boolean</td>
                        <td>静态属性</td>
                        <td>-</td>
                    </tr>
...
import * as code from "examples/codes/control-bar";
